...
func (l *RegionBhv) Update(region *entity.Region, tx *sql.Tx) (int64, error) {
	var entity df.Entity = region
	return l.BaseBehavior.DoUpdate(&entity, nil, tx)
}
func (l *RegionBhv) Insert(region *entity.Region, tx *sql.Tx) (int64, error) {
	var entity df.Entity = region
	return l.BaseBehavior.DoInsert(&entity, nil, tx)
}
func (l *RegionBhv) Delete(region *entity.Region, tx *sql.Tx) (int64, error) {
	var entity df.Entity = region
...
func (l *RegionBhv) ReadNextVal(tx *sql.Tx) (int64,error){
