...
func (l *WhiteDelimiterBhv) Update(whiteDelimiter *entity.WhiteDelimiter, tx *sql.Tx) (int64, error) {
	var entity df.Entity = whiteDelimiter
	return l.BaseBehavior.DoUpdate(&entity, nil, tx)
}
func (l *WhiteDelimiterBhv) Insert(whiteDelimiter *entity.WhiteDelimiter, tx *sql.Tx) (int64, error) {
	var entity df.Entity = whiteDelimiter
	return l.BaseBehavior.DoInsert(&entity, nil, tx)
}
func (l *WhiteDelimiterBhv) Delete(whiteDelimiter *entity.WhiteDelimiter, tx *sql.Tx) (int64, error) {
	var entity df.Entity = whiteDelimiter
...
func (l *WhiteDelimiterBhv) ReadNextVal(tx *sql.Tx) (int64,error){
