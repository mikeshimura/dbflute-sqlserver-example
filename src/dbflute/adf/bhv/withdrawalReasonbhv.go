...
func (l *WithdrawalReasonBhv) Update(withdrawalReason *entity.WithdrawalReason, tx *sql.Tx) (int64, error) {
	var entity df.Entity = withdrawalReason
	return l.BaseBehavior.DoUpdate(&entity, nil, tx)
}
func (l *WithdrawalReasonBhv) Insert(withdrawalReason *entity.WithdrawalReason, tx *sql.Tx) (int64, error) {
	var entity df.Entity = withdrawalReason
	return l.BaseBehavior.DoInsert(&entity, nil, tx)
}
func (l *WithdrawalReasonBhv) Delete(withdrawalReason *entity.WithdrawalReason, tx *sql.Tx) (int64, error) {
	var entity df.Entity = withdrawalReason
...
func (l *WithdrawalReasonBhv) ReadNextVal(tx *sql.Tx) (int64,error){
