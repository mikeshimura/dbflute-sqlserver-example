...
func (l *MemberBhv) Update(member *entity.Member, tx *sql.Tx) (int64, error) {
	var entity df.Entity = member
	return l.BaseBehavior.DoUpdate(&entity, nil, tx)
}
func (l *MemberBhv) Insert(member *entity.Member, tx *sql.Tx) (int64, error) {
	var entity df.Entity = member
	return l.BaseBehavior.DoInsert(&entity, nil, tx)
}
func (l *MemberBhv) Delete(member *entity.Member, tx *sql.Tx) (int64, error) {
	var entity df.Entity = member
...
func (l *MemberBhv) ReadNextVal(tx *sql.Tx) (int64,error){
