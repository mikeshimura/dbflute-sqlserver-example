...
func Create_SummaryWithdrawalDbm() {
	...
	SummaryWithdrawalDbm.TableSqlName.TableSqlName = "exampledb.dbo.SUMMARY_WITHDRAWAL"
	...
	SummaryWithdrawalDbm.ColumnMemberName = df.CCI(&summaryWithdrawal, "MEMBER_NAME", memberNameSqlName, "", "", "String.class", "memberName", "", false, false,false, "nvarchar", 200, 0, "",false,"","", "","","",false,"df.NullString")
	...
	SummaryWithdrawalDbm.ColumnWithdrawalReasonText = df.CCI(&summaryWithdrawal, "WITHDRAWAL_REASON_TEXT", withdrawalReasonTextSqlName, "", "", "String.class", "withdrawalReasonText", "", false, false,false, "text", 2147483647, 0, "",false,"","", "","","",false,"df.NullString")
	...
	SummaryWithdrawalDbm.ColumnWithdrawalReasonInputText = df.CCI(&summaryWithdrawal, "WITHDRAWAL_REASON_INPUT_TEXT", withdrawalReasonInputTextSqlName, "", "", "String.class", "withdrawalReasonInputText", "", false, false,false, "text", 2147483647, 0, "",false,"","", "","","",false,"df.NullString")
	...
	SummaryWithdrawalDbm.ColumnWithdrawalDatetime = df.CCI(&summaryWithdrawal, "WITHDRAWAL_DATETIME", withdrawalDatetimeSqlName, "", "", "java.time.LocalDateTime.class", "withdrawalDatetime", "", false, false,true, "datetime", 23, 3, "",false,"","", "","","",false,"df.Timestamp")
	...
	SummaryWithdrawalDbm.ColumnMemberStatusName = df.CCI(&summaryWithdrawal, "MEMBER_STATUS_NAME", memberStatusNameSqlName, "", "", "String.class", "memberStatusName", "", false, false,false, "nvarchar", 50, 0, "",false,"","", "","","",false,"df.NullString")
	...
	SummaryWithdrawalDbm.ColumnMaxPurchasePrice = df.CCI(&summaryWithdrawal, "MAX_PURCHASE_PRICE", maxPurchasePriceSqlName, "", "", "Integer.class", "maxPurchasePrice", "", false, false,false, "int", 10, 0, "",false,"","", "","","",false,"sql.NullInt64")
