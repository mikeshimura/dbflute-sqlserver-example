...
public abstract class AbstractBsMemberCQ extends AbstractConditionQuery {
     ...
     * MEMBER_NAME: {NotNull, nvarchar(200)} <br>
    ...
    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * MEMBER_ACCOUNT: {UQ, NotNull, nvarchar(50)} <br>
     ...
     * Equal(=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * BIRTHDATE: {date(10)}
     * @param birthdate The value of birthdate as equal. (NullAllowed: if null (or empty), no condition)
     */
    public void setBirthdate_Equal(String birthdate) {
        doSetBirthdate_Equal(fRES(birthdate));
    }

    protected void doSetBirthdate_Equal(String birthdate) {
     ...
     * NotEqual(&lt;&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * BIRTHDATE: {date(10)}
     * @param birthdate The value of birthdate as notEqual. (NullAllowed: if null (or empty), no condition)
     */
    public void setBirthdate_NotEqual(String birthdate) {
        doSetBirthdate_NotEqual(fRES(birthdate));
    }

    protected void doSetBirthdate_NotEqual(String birthdate) {
        regBirthdate(CK_NES, birthdate);
    }

    /**
     * GreaterThan(&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * BIRTHDATE: {date(10)}
     * @param birthdate The value of birthdate as greaterThan. (NullAllowed: if null (or empty), no condition)
     */
    public void setBirthdate_GreaterThan(String birthdate) {
        regBirthdate(CK_GT, fRES(birthdate));
    }

    /**
     * LessThan(&lt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * BIRTHDATE: {date(10)}
     * @param birthdate The value of birthdate as lessThan. (NullAllowed: if null (or empty), no condition)
     */
    public void setBirthdate_LessThan(String birthdate) {
        regBirthdate(CK_LT, fRES(birthdate));
    }

    /**
     * GreaterEqual(&gt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * BIRTHDATE: {date(10)}
     * @param birthdate The value of birthdate as greaterEqual. (NullAllowed: if null (or empty), no condition)
     */
    public void setBirthdate_GreaterEqual(String birthdate) {
        regBirthdate(CK_GE, fRES(birthdate));
    }

    /**
     * LessEqual(&lt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * BIRTHDATE: {date(10)}
     * @param birthdate The value of birthdate as lessEqual. (NullAllowed: if null (or empty), no condition)
     */
    public void setBirthdate_LessEqual(String birthdate) {
        regBirthdate(CK_LE, fRES(birthdate));
    }
     ...
     */
    public void setBirthdate_InScope(Collection<String> birthdateList) {
        doSetBirthdate_InScope(birthdateList);
    }

    protected void doSetBirthdate_InScope(Collection<String> birthdateList) {
     ...
     */
    public void setBirthdate_NotInScope(Collection<String> birthdateList) {
        doSetBirthdate_NotInScope(birthdateList);
    }

    protected void doSetBirthdate_NotInScope(Collection<String> birthdateList) {
        regINS(CK_NINS, cTL(birthdateList), xgetCValueBirthdate(), "BIRTHDATE");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * BIRTHDATE: {date(10)} <br>
     * <pre>e.g. setBirthdate_LikeSearch("xxx", op <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> op.<span style="color: #CC4747">likeContain()</span>);</pre>
     * @param birthdate The value of birthdate as likeSearch. (NullAllowed: if null (or empty), no condition)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setBirthdate_LikeSearch(String birthdate, ConditionOptionCall<LikeSearchOption> opLambda) {
        setBirthdate_LikeSearch(birthdate, xcLSOP(opLambda));
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * BIRTHDATE: {date(10)} <br>
     * <pre>e.g. setBirthdate_LikeSearch("xxx", new <span style="color: #CC4747">LikeSearchOption</span>().likeContain());</pre>
     * @param birthdate The value of birthdate as likeSearch. (NullAllowed: if null (or empty), no condition)
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    protected void setBirthdate_LikeSearch(String birthdate, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(birthdate), xgetCValueBirthdate(), "BIRTHDATE", likeSearchOption);
    }
     ...
     * And NullOrEmptyIgnored, SeveralRegistered. <br>
     * BIRTHDATE: {date(10)}
     * @param birthdate The value of birthdate as notLikeSearch. (NullAllowed: if null (or empty), no condition)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setBirthdate_NotLikeSearch(String birthdate, ConditionOptionCall<LikeSearchOption> opLambda) {
        setBirthdate_NotLikeSearch(birthdate, xcLSOP(opLambda));
    }
     ...
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    protected void setBirthdate_NotLikeSearch(String birthdate, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(birthdate), xgetCValueBirthdate(), "BIRTHDATE", likeSearchOption);
    }
     ...
     * BIRTHDATE: {date(10)}
     */
    public void setBirthdate_IsNullOrEmpty() { regBirthdate(CK_ISNOE, DOBJ); }
