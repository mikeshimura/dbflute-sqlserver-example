...
public abstract class AbstractBsSummaryWithdrawalCQ extends AbstractConditionQuery {
    ...
    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * WITHDRAWAL_REASON_TEXT: {TEXT(65535)} <br>
    ...
    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * WITHDRAWAL_REASON_INPUT_TEXT: {TEXT(65535)} <br>
     ...
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    protected void setMaxPurchasePrice_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
