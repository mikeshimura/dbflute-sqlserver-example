...
public abstract class BsVendorConstraintNameAutoQuxBhv extends AbstractBehaviorWritable<VendorConstraintNameAutoQux, VendorConstraintNameAutoQuxCB> {
     ...
     */
    public NestedReferrerListGateway<VendorConstraintNameAutoRef> loadVendorConstraintNameAutoRef(List<VendorConstraintNameAutoQux> vendorConstraintNameAutoQuxList, ReferrerConditionSetupper<VendorConstraintNameAutoRefCB> refCBLambda) {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<VendorConstraintNameAutoRef> loadVendorConstraintNameAutoRef(VendorConstraintNameAutoQux vendorConstraintNameAutoQux, ReferrerConditionSetupper<VendorConstraintNameAutoRefCB> refCBLambda) {
