package com.mssoftech.dbflute.bsbhv.pmbean;
//sqlfile= {main, ..\src\dbflute\adf\bhv\sql, MemberBhv_testUpdateMember.sql}
import java.util.*;
...
/**
 * The base class for parameter-bean of UpdateMember.
 * @author DBFlute(AutoGenerator)
 */
public class BsUpdateMemberPmb implements ParameterBean, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the parameter-bean of UpdateMember.
     */
    public BsUpdateMemberPmb() {
    }
