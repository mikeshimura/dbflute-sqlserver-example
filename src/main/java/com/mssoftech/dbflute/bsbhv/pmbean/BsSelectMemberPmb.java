...
//sqlfile= {main, ..\src\dbflute\adf\bhv\sql, MemberBhv_testSelectMember.sql}
import java.util.*;
...
/**
 * The base class for parameter-bean of SelectMember.
 * @author DBFlute(AutoGenerator)
 */
public class BsSelectMemberPmb implements ParameterBean, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the parameter-bean of SelectMember.
     */
    public BsSelectMemberPmb() {
    }
