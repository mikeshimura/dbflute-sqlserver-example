...
public abstract class BsProductCategory extends AbstractEntity implements DomainEntity {
    ...
    /**
     * [get] PRODUCT_CATEGORY_NAME: {NotNull, nvarchar(50)} <br>
    ...
    /**
     * [set] PRODUCT_CATEGORY_NAME: {NotNull, nvarchar(50)} <br>
    ...
    /**
     * [get] PARENT_CATEGORY_CODE: {char(3), FK to PRODUCT_CATEGORY} <br>
    ...
    /**
     * [set] PARENT_CATEGORY_CODE: {char(3), FK to PRODUCT_CATEGORY} <br>
