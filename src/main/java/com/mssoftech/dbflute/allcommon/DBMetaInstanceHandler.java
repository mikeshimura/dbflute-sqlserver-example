package com.mssoftech.dbflute.allcommon;
...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("member", "com.mssoftech.dbflute.bsentity.dbmeta.MemberDbm");
        tmpMap.put("member_address", "com.mssoftech.dbflute.bsentity.dbmeta.MemberAddressDbm");
        tmpMap.put("member_login", "com.mssoftech.dbflute.bsentity.dbmeta.MemberLoginDbm");
        tmpMap.put("member_security", "com.mssoftech.dbflute.bsentity.dbmeta.MemberSecurityDbm");
        tmpMap.put("member_service", "com.mssoftech.dbflute.bsentity.dbmeta.MemberServiceDbm");
        tmpMap.put("member_status", "com.mssoftech.dbflute.bsentity.dbmeta.MemberStatusDbm");
        tmpMap.put("member_withdrawal", "com.mssoftech.dbflute.bsentity.dbmeta.MemberWithdrawalDbm");
        tmpMap.put("product", "com.mssoftech.dbflute.bsentity.dbmeta.ProductDbm");
        tmpMap.put("product_category", "com.mssoftech.dbflute.bsentity.dbmeta.ProductCategoryDbm");
        tmpMap.put("product_status", "com.mssoftech.dbflute.bsentity.dbmeta.ProductStatusDbm");
        tmpMap.put("purchase", "com.mssoftech.dbflute.bsentity.dbmeta.PurchaseDbm");
        tmpMap.put("purchase_payment", "com.mssoftech.dbflute.bsentity.dbmeta.PurchasePaymentDbm");
        ...
        tmpMap.put("vendor_constraint_name_auto_bar", "com.mssoftech.dbflute.bsentity.dbmeta.VendorConstraintNameAutoBarDbm");
        tmpMap.put("vendor_constraint_name_auto_foo", "com.mssoftech.dbflute.bsentity.dbmeta.VendorConstraintNameAutoFooDbm");
        tmpMap.put("vendor_constraint_name_auto_qux", "com.mssoftech.dbflute.bsentity.dbmeta.VendorConstraintNameAutoQuxDbm");
        tmpMap.put("vendor_constraint_name_auto_ref", "com.mssoftech.dbflute.bsentity.dbmeta.VendorConstraintNameAutoRefDbm");
        ...
        tmpMap.put("vendor_the_long_and_winding_table_and_column", "com.mssoftech.dbflute.bsentity.dbmeta.VendorTheLongAndWindingTableAndColumnDbm");
        tmpMap.put("vendor_the_long_and_winding_table_and_column_ref", "com.mssoftech.dbflute.bsentity.dbmeta.VendorTheLongAndWindingTableAndColumnRefDbm");
